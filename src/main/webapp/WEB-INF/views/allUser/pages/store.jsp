					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="header-logo">
								<a href="#" class="logo">
									<img src="/QUANLYHOACU/static/allUser/./image/logo4.png" alt="" width="153"
										height="70" border="0" />
								</a>
							</div>
						</div>
						...
						<div class="col-md-3 clearfix">
							<div class="header-ctn">
								...
								<!-- Cart -->
								<div class="dropdown">
									<a href="CheckOut" aria-expanded="false" class="dropdown-toggle"
									...
									<div class="cart-dropdown">
										...
										<div class="cart-btns">
											<a href="CheckOut">View Cart<i class="fa fa-arrow-circle-right"></i>
											</a>
										</div>
									</div>
								</div>
						...
						<div class="aside">
							...
							<div class="checkbox-filter">
								<div class="input-checkbox">
									<input type="checkbox" id="category-1" /> <label for="category-1"> <span></span> Màu
										vẽ <small>(120)</small>
									</label>
								</div>
								...
								<div class="input-checkbox">
									<input type="checkbox" id="category-2" /> <label for="category-2"> <span></span>
										Giấy vẽ <small>(740)</small>
									</label>
								</div>

								<div class="input-checkbox">
									<input type="checkbox" id="category-3" /> <label for="category-3"> <span></span> Bút
										vẽ <small>(1450)</small>
									</label>
								</div>
								...
								<div class="input-checkbox">
									<input type="checkbox" id="category-4" /> <label for="category-4"> <span></span>
										Phác thảo <small>(578)</small>
									</label>
								</div>

								<div class="input-checkbox">
									<input type="checkbox" id="category-5" /> <label for="category-5"> <span></span>
										Dụng cụ bổ trợ <small>(120)</small>
									</label>
								</div>

								<div class="input-checkbox">
									<input type="checkbox" id="category-6" /> <label for="category-6"> <span></span> Văn
										phòng phẩm <small>(740)</small>
									</label>
								</div>
							</div>
						</div>
